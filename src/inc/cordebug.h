...
#ifndef __ICorDebugMutableDataTarget2_FWD_DEFINED__
#define __ICorDebugMutableDataTarget2_FWD_DEFINED__
typedef interface ICorDebugMutableDataTarget2 ICorDebugMutableDataTarget2;

#endif 	/* __ICorDebugMutableDataTarget2_FWD_DEFINED__ */
...
#ifndef __ICorDebugMutableDataTarget2_INTERFACE_DEFINED__
#define __ICorDebugMutableDataTarget2_INTERFACE_DEFINED__

/* interface ICorDebugMutableDataTarget2 */
/* [unique][local][uuid][object] */ 


EXTERN_C const IID IID_ICorDebugMutableDataTarget2;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("959807f5-cc2a-40d5-9461-600e603a4fb6")
    ICorDebugMutableDataTarget2 : public ICorDebugMutableDataTarget
    {
    public:
        virtual HRESULT STDMETHODCALLTYPE GetHashCode( 
            /* [in] */ CORDB_ADDRESS objAddr,
            /* [out] */ LONG32 *pHashCode) = 0;
    ...
    typedef struct ICorDebugMutableDataTarget2Vtbl
    {
        BEGIN_INTERFACE
        
        HRESULT ( STDMETHODCALLTYPE *QueryInterface )( 
            ICorDebugMutableDataTarget2 * This,
            /* [in] */ REFIID riid,
            /* [annotation][iid_is][out] */ 
            _COM_Outptr_  void **ppvObject);
        ...
        HRESULT ( STDMETHODCALLTYPE *GetHashCode )( 
            ICorDebugMutableDataTarget2 * This,
            /* [in] */ CORDB_ADDRESS objAddr,
            /* [out] */ LONG32 *pHashCode);
        
        END_INTERFACE
    } ICorDebugMutableDataTarget2Vtbl;

    interface ICorDebugMutableDataTarget2
    {
        CONST_VTBL struct ICorDebugMutableDataTarget2Vtbl *lpVtbl;
    };
...
#define ICorDebugMutableDataTarget2_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define ICorDebugMutableDataTarget2_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define ICorDebugMutableDataTarget2_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 


#define ICorDebugMutableDataTarget2_GetPlatform(This,pTargetPlatform)	\
    ( (This)->lpVtbl -> GetPlatform(This,pTargetPlatform) ) 

#define ICorDebugMutableDataTarget2_ReadVirtual(This,address,pBuffer,bytesRequested,pBytesRead)	\
    ( (This)->lpVtbl -> ReadVirtual(This,address,pBuffer,bytesRequested,pBytesRead) ) 

#define ICorDebugMutableDataTarget2_GetThreadContext(This,dwThreadID,contextFlags,contextSize,pContext)	\
    ( (This)->lpVtbl -> GetThreadContext(This,dwThreadID,contextFlags,contextSize,pContext) ) 


#define ICorDebugMutableDataTarget2_WriteVirtual(This,address,pBuffer,bytesRequested)	\
    ( (This)->lpVtbl -> WriteVirtual(This,address,pBuffer,bytesRequested) ) 

#define ICorDebugMutableDataTarget2_SetThreadContext(This,dwThreadID,contextSize,pContext)	\
    ( (This)->lpVtbl -> SetThreadContext(This,dwThreadID,contextSize,pContext) ) 

#define ICorDebugMutableDataTarget2_ContinueStatusChanged(This,dwThreadId,continueStatus)	\
    ( (This)->lpVtbl -> ContinueStatusChanged(This,dwThreadId,continueStatus) ) 


#define ICorDebugMutableDataTarget2_GetHashCode(This,objAddr,pHashCode)	\
    ( (This)->lpVtbl -> GetHashCode(This,objAddr,pHashCode) ) 
...
#endif 	/* __ICorDebugMutableDataTarget2_INTERFACE_DEFINED__ */
